  ...
  return (
    <div className="fixed right-4 bottom-4 z-30 flex flex-col items-end gap-3 sm:right-6 sm:bottom-6">
        ...
        >
          <div className="flex items-center justify-between border-b border-gold/25 px-5 py-3">
            ...
            <button
              ...
              className="p-1 text-gold transition-colors hover:text-gold-soft focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-soft"
            >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 bg-gold px-5 py-3 text-sm font-semibold tracking-wide text-plum shadow-lg transition-transform hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-soft active:translate-y-0"
      >
