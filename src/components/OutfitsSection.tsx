  ...
  return (
    <section id="outfits" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-4 max-w-[60ch] leading-relaxed text-moss">
              Seven decades of sequins, wigs and one very famous set of nails. Swipe or use the
              arrows.
            </p>
          </div>
      ...
      <Reveal className="mt-12">
        <div role="region" aria-roledescription="carousel" aria-label="Dolly Parton look book">
          <ul
            ref={trackRef}
