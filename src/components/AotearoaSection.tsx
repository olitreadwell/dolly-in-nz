...
/**
 * The Aotearoa twist: Auckland got every show she ever played here, so the
 * rest of the country sings for her.
 *
        ...
        <Reveal className="relative">
          <div className="border border-gold/30 bg-ink-3 p-8">
            ...
            <p className="mt-4 font-display text-2xl leading-snug italic text-cream">
              &ldquo;Auckland got the shows. Aotearoa kept the songs.&rdquo;
            </p>
            <p className="mt-4 text-sm text-moss">Aotearoa, land of the long white cloud</p>
          </div>
        </Reveal>
      </div>
    </section>
