...
export const galleryImages: readonly GalleryImage[] = [
  ...
  {
    src: getMemorialImageUrl('dolly-young-scan.jpg'),
    alt: 'A high quality scan of a young Dolly Parton',
    caption: 'The young Dolly, high-resolution scan',
    credit: 'Goldband Records',
    license: 'Public domain',
    sourceUrl:
      'https://commons.wikimedia.org/wiki/File:Young-Dolly-Parton_(higher_quality_scan).jpg',
  },
  {
    src: getMemorialImageUrl('dolly-porter-1969.jpg'),
    alt: 'Porter Wagoner and Dolly Parton together in 1969',
    caption: 'With Porter Wagoner, 1969',
    credit: 'Publicity photo',
    license: 'Public domain',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Porter_Wagoner_and_Dolly_Parton_1969.jpg',
  },
  {
    src: getMemorialImageUrl('dolly-1984-kahala-2.jpg'),
    alt: 'Dolly Parton at the Kahala Hilton in Honolulu',
    caption: 'Kahala Hilton, Honolulu, 1984',
    credit: 'Alan Light',
    license: 'CC BY 2.0',
  ...
  },
  {
    ...
    alt: 'Dolly Parton looking happy and surprised at the Kennedy Center',
    caption: 'Kennedy Center, October 2003',
    credit: 'White House photographer',
    license: 'CC BY-SA 2.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dolly_Parton_happy_and_surprised.jpg',
  },
  {
    src: getMemorialImageUrl('dolly-reading-loc.png'),
    alt: 'Dolly Parton reading to children in the Library of Congress Great Hall',
    caption: 'Reading in the Library of Congress Great Hall, 2018',
    credit: 'Library of Congress',
    license: 'Public domain',
    sourceUrl:
      'https://commons.wikimedia.org/wiki/File:Dolly_Parton_reads_to_children_in_the_Library_of_Congress_Great_Hall_in_2018.png',
  },
  {
    src: getMemorialImageUrl('dolly-hollywood-star.jpg'),
    alt: 'Dolly Parton star on the Hollywood Walk of Fame',
    caption: 'Her star on the Hollywood Walk of Fame',
    credit: 'Photo of her star',
    license: 'CC BY 2.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Hollywood_Star_Dolly_Parton.jpg',
  },
  {
    src: getMemorialImageUrl('dollywood-sign.jpg'),
    alt: 'The Dollywood park sign in Pigeon Forge',
    caption: 'The Dollywood sign, Pigeon Forge',
    credit: 'Photo of the park sign',
    license: 'CC BY 2.5',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dollywoodsign1.jpg',
  },
];
...
export const outfitLooks: readonly OutfitLook[] = [
  ...
  {
    src: getMemorialImageUrl('dolly-1984-hawaii-2.jpg'),
    alt: 'Dolly Parton in a white outfit at the Kahala Hilton in April 1984',
    era: '1984',
    caption: 'The same 1984 session, another angle',
    credit: 'Alan Light',
    license: 'CC BY 2.0',
  ...
  },
  {
    ...
    alt: 'Dolly Parton in a black sequinned jacket at the National Press Club in 2000',
    era: '2000',
  ...
  {
    src: getMemorialImageUrl('dolly-opry-costume.jpg'),
    alt: 'Dolly Parton\u2019s 1969 Grand Ole Opry stage wear on display at the Country Music Hall of Fame',
    era: '1969',
    caption: 'Grand Ole Opry stage wear, 1969',
    credit: 'Country Music Hall of Fame and Museum',
    license: 'CC0',
    sourceUrl:
      'https://commons.wikimedia.org/wiki/File:Dolly_Parton%27s_stage_wear_when_joined_as_the_cast_the_Grand_Ole_Opry_in_1969-01-04_-_brocade_overwear_and_dress_with_brocade_collar_(by_Lney_Adams),_Renetti_pumps_-_Country_Music_Hall_of_Fame_and_Museum_(2018-08-21_13.49.31_by_e_Kat).jpg',
  },
  {
    src: getMemorialImageUrl('dolly-coat-many-colors.jpg'),
    alt: 'The Coat of Many Colors on display',
    era: '1971',
    caption: 'The Coat of Many Colors',
    credit: 'Photo of the coat on display',
    license: 'CC BY-SA 4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:DollyPartonCoatOfManyColors.jpg',
  },
  {
    src: getMemorialImageUrl('dolly-coat-detail.jpg'),
    alt: 'A close up of the Coat of Many Colors patchwork',
    era: '1971',
    caption: 'The Coat of Many Colors, close up',
    credit: 'Photo of the coat on display',
    license: 'CC BY-SA 4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Coat_of_Many_Colors_coat.jpg',
  },
];
